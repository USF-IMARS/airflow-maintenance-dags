...
airflow trigger_dag --conf '{"dagIgnoreList":"my_special_dag,my_other_special_dag"}' airflow-db-cleanup
...
def print_configuration_function(**context):
    ...
    if dag_ignore_list is None:
        logging.info("dagIgnoreList conf variable isn't included. Using Default '" + str(DEFAULT_DAG_IGNORE_LIST) + "'")
